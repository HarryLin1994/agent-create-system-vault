...
- Does not treat downloaded content as trusted evidence until source notes pass AI self-review.
...
- If a content type is unknown, save it with a safe extension and require AI review before source-note creation.
